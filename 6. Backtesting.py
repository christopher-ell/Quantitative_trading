...
all_coint_returns = pd.DataFrame(columns = ['symbol_id1','symbol_id2','return'])

#unique1_coint_res = all_coint_res.symbol_id1.unique().tolist()
#unique2_coint_res = all_coint_res.symbol_id2.unique().tolist()
...
for i in range(0, len(all_coint_res)):
    ...
    print("Symbol1: ", symbol_id1)
    print("Symbol2: ", symbol_id2)
    ...
    ret = backtester['return'].sum()

    all_coint_returns.loc[i+1]=[symbol_id1, symbol_id2, ret]